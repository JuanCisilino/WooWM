...
object AmazonUtil {
    ...
    internal fun getCredProvider(context: Context?): CognitoCachingCredentialsProvider? {
        if (credProvider == null) {
            ...
            credProvider = CognitoCachingCredentialsProvider(
                context,
                "us-east-1:aa67dca0-28b7-4876-b335-fb69a233e77f",
    ...
    fun getS3Client(context: Context?): AmazonS3Client? {
        if (amzonS3Client == null) {
            amzonS3Client = AmazonS3Client(getCredProvider(context),Region.getRegion(Regions.US_EAST_1))
            amzonS3Client!!.setRegion(Region.getRegion(Regions.US_EAST_1))
        }
